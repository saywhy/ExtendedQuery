        ...
        <div class="container">
            ...
            <div class="report clearfix">
                <div class="report_top clearfix">
                    <div class="report_top_title_box">
                        <div class="report_top_title_box_left">
                            ...
                            <span class="report_top_name" :class="{red:domain_data.Zone=='Red',yellow:domain_data.Zone=='Yellow',grey:domain_data.Zone=='Grey',green:domain_data.Zone=='Green'}">{{domain_data.Zone_hoohoolab}}</span>
                        </div>
                ...
                <div class="report_mid">
                    <el-row class="report_mid_item">
                        <el-col :span="6" class="report_mid_item_col">
                            ...
                            <p class="report_mid_item_col_value" :title="domain_data.DomainGeneralInfo.Ipv4Count">{{domain_data.DomainGeneralInfo.Ipv4Count}}</p>
                        </el-col>
                        <el-col :span="6" class="report_mid_item_col">
                            <p class="report_mid_item_col_name">Files Count</p>
                            <p class="report_mid_item_col_value" :title="domain_data.DomainGeneralInfo.FilesCount">{{domain_data.DomainGeneralInfo.FilesCount}}</p>
                        </el-col>
                        <el-col :span="6" class="report_mid_item_col">
                            <p class="report_mid_item_col_name">URLs count</p>
                            <p class="report_mid_item_col_value" :title="domain_data.DomainGeneralInfo.UrlsCount">{{domain_data.DomainGeneralInfo.UrlsCount}}</p>
                        </el-col>
                        <el-col :span="6" class="report_mid_item_col">
                            <p class="report_mid_item_col_name">Registration organization</p>
                            <p class="report_mid_item_col_value">
                                <span v-if="item_type.whois" :title="domain_data.DomainWhoIsInfo.RegistrationOrganization">
                        ...
                        <el-col :span="6" class="report_mid_item_col">
                            ...
                            <p class="report_mid_item_col_value">
                                <span v-if="item_type.whois" :title="domain_data.DomainWhoIsInfo.Created">
                        ...
                        <el-col :span="6" class="report_mid_item_col">
                            ...
                            <p class="report_mid_item_col_value">
                                <span v-if="item_type.whois" :title="domain_data.DomainWhoIsInfo.Expires">
                        ...
                        <el-col :span="6" class="report_mid_item_col">
                            ...
                            <p class="report_mid_item_col_value">
                                <span v-if="item_type.whois" :title="domain_data.DomainWhoIsInfo.DomainName">
                        ...
                        <el-col :span="6" class="report_mid_item_col">
                            ...
                            <p class="report_mid_item_col_value">
                                <span v-if="item_type.whois" :title="domain_data.DomainWhoIsInfo.Registrar.Info">
                ...
                <div class="report_bom">
                    ...
                    <span v-for="item in domain_data.DomainGeneralInfo.Categories" class="report_bom_box">
                ...
                <div class="whois_mid ">
                    <el-row class="whois_mid_item">
                        <el-col :span="6" class="whois_mid_item_col">
                            ...
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.DomainName">{{domain_data.DomainWhoIsInfo.DomainName}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Domain Status</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.DomainStatus_cn">{{domain_data.DomainWhoIsInfo.DomainStatus_cn}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Created</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Created">{{domain_data.DomainWhoIsInfo.Created}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Updated</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Updated">{{domain_data.DomainWhoIsInfo.Updated}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Paid Until</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Expires">{{domain_data.DomainWhoIsInfo.Expires}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Registrar Ifro</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Registrar.Info">{{domain_data.DomainWhoIsInfo.Registrar.Info}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">IANA ID</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Registrar.IanaId">{{domain_data.DomainWhoIsInfo.Registrar.IanaId}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Email</p>
                            <p class="whois_mid_item_col_value" :title="domain_data.DomainWhoIsInfo.Registrar.Email">{{domain_data.DomainWhoIsInfo.Registrar.Email}}</p>
                        </el-col>
                        <el-col :span="6" class="whois_mid_item_col">
                            <p class="whois_mid_item_col_name">Name Servers</p>
                            <p class="whois_mid_item_col_value" v-for="item in domain_data.DomainWhoIsInfo.NameServers">
                                <span>{{item}}</span>
                            </p>
                        </el-col>
                    </el-row>
            ...
            <!-- Referrals to domain -->
            <div class="requested" v-if="item_type.Referrals">
                <div class="requested_top ">
                ...
                <div class="requested_bom">
                    ...
                    <v-page class="requested_page" :total-row="referralstotalRow" :page-size-menu='false' @page-change="referralspageChange" :border="false" align="center"></v-page>
                </div>
            </div>
            <!-- URL Marks -->
            <div class="requested" v-if="item_type.Marks">
                <div class="requested_top ">
                ...
                <div class="requested_bom">
                    <table>
                        ...
                        <tr v-for="item in markspageArr">
                            ...
                            <td style="padding-right:36px;" :title="item.FeedNames_cn">{{item.FeedNames_cn}}</td>
                        </tr>
                    </table>
                    <v-page class="requested_page" :total-row="markstotalRow" :page-size-menu='false' @page-change="markspageChange" :border="false" align="center"></v-page>
                </div>
            </div>
        </div>
    </div>
      ...
      this.$axios
        ...
        .get("/intelligence/extension", {
          params: {
            ...
            // indicator: "000nwlz.wcomhost.com/logs/log/accountdetails.php"
          }
        })
        .then(response => {
          if (response.data.status == "success") {
            ...
            if (response.data.data.result.DomainWhoIsInfo) {
              this.whoistotalRow =
                response.data.data.result.DomainWhoIsInfo.Contacts.length;
              if (response.data.data.result.DomainWhoIsInfo.DomainStatus) {
                response.data.data.result.DomainWhoIsInfo.DomainStatus_cn =
                  response.data.data.result.DomainWhoIsInfo.DomainStatus[0];
              } else {
                response.data.data.result.DomainWhoIsInfo.DomainStatus_cn = "";
              }
            ...
            if (response.data.data.result.UrlReferrals) {
              response.data.data.result.UrlReferrals.forEach(item => {
                switch (item.Zone) {
                  case "Red":
                    item.Zone_hoohoolab = "Malware";
                    break;
              ...
              this.referralstotalRow =
                response.data.data.result.UrlReferrals.length;
            ...
            if (response.data.data.result.FeedMasks) {
              ...
              this.markstotalRow = response.data.data.result.FeedMasks.length;
